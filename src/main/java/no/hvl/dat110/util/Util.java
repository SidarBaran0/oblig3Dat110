...
public class Util {
	 ...
	 * To use this method to compute (lower < id <= upper), ensure that the calling
	 * method increased the lower param by 1.
	 * To use this method to compute (lower <= id < upper), ensure that the calling
	 * method increased the upper param by 1.
	 * To use this method to compute (lower < id < upper), ensure that the calling
	 * method increased both the lower and upper params by 1.
	 * 
	 * @param id
	 * @param lower
	 * @param upper
